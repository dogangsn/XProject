...
namespace XProject.Identity.Infrastructure.Migrations
{
    ...
    [Migration("20220709215019_accountUpdate")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("XProject.Identity.Infrastructure.Entities.ApplicationUser", null)
                        .WithMany()
            ...
            modelBuilder.Entity("XProject.Identity.Infrastructure.Entities.Account", b =>
                {
                    b.HasOne("XProject.Identity.Infrastructure.Entities.ApplicationUser", "User")
                        .WithOne("Account")
                        .HasForeignKey("XProject.Identity.Infrastructure.Entities.Account", "UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
